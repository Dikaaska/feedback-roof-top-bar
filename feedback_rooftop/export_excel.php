...
/* Header */
echo "<table>
<tr><td colspan='10' class='header-title'>Roof Top Pool Bar Feedback Report</td></tr>
<tr><td colspan='10' class='header-period'>Period: $from to $to</td></tr>
<br>
</table>";
...
<th>Swimming</th><th>Food</th><th>Beverage</th><th>WiFi</th><th>Music</th><th>Avg</th><th>Note</th>
</tr>";
